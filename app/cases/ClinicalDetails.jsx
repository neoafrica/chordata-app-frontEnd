...
import { RelatedCase, deleteCase, getComments } from "../Api/post";
...
export default function ClinicalDetails({ navigation }) {
      ...
      <NetworkStatusBanner/>
        ...
        >
          ...
          {clinical ? (
            <TouchableOpacity
              activeOpacity={0.8}
              onPress={clinicalFinds}
              style={[
                styles.tabBar,
                { backgroundColor: clinical ? "#028704" : "#1989b9" },
              ]}
            >
              <FontAwesome5 name="microscope" size={22} color={"#fff"} />
              <Text style={styles.tabText}>Clincal Findings</Text>
              {clinical ? (
                <Ionicons
                  name="chevron-down-circle-outline"
                  size={26}
            ...
            <View>
              ...
              >
                <FontAwesome5 name="microscope" size={22} color={"#fff"} />
                <Text style={[styles.tabText]}>Clinical Findings</Text>
              ...
              <View style={{ marginTop: 8, width: 322 }}>
                ...
                >
                  {FormatText(route.params.clinicalFindings)}
                </Text>
              </View>
            </View>
          )}
          ...
          {management ? (
            <TouchableOpacity
              ...
              style={[
                styles.tabBar,
                { backgroundColor: management ? "#028704" : "#1989b9" },
              ]}
            >
              <Fontisto name="injection-syringe" size={22} color={"#fff"} />
              <Text style={styles.tabText}>Management</Text>
              {management ? (
                <Ionicons
                  name="chevron-down-circle-outline"
                  size={26}
            ...
            <View>
              ...
              <View style={{ marginTop: 8, width: 322 }}>
                ...
                >
                  {FormatText(route.params.management)}
                </Text>
              </View>
            </View>
          )}
          ...
          {drugs ? (
            <TouchableOpacity
              ...
              style={[
                styles.tabBar,
                { backgroundColor: drugs ? "#028704" : "#1989b9" },
              ]}
            >
              <MaterialCommunityIcons
                ...
                color={"#fff"}
              />
              <Text style={styles.tabText}>Drugs used</Text>
              {drugs ? (
                <Ionicons
                  name="chevron-down-circle-outline"
                  size={26}
            ...
            <View>
              ...
              <View style={{ marginTop: 8, width: 322 }}>
                ...
                >
                  {FormatText(route.params.drugsUsed)}
                </Text>
              </View>
            </View>
          )}
