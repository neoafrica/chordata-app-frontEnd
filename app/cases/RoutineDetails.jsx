...
export default function RoutineDetails({ navigation }) {
  ...
  return (
   ...
   <NetworkStatusBanner/>
        ...
        >
          ...
          <View style={{ marginBottom: 10, width: 322 }}>
            <Text
              style={{
                fontSize: 14,
                // paddingTop: 16,
            ...
            >
              bio-data -- {route.params.ageOfAnimal} ,{route.params.sexOfAnimal}
              , {route.params.typeOfAnimal} #{route.params.managementCategory}
            </Text>
            <Text
              style={{
                fontSize: 15,
            ...
            >
              {FormatText(route.params.description)}
            </Text>
          </View>
          {/* ***************************************************** */}
          <Sponsorlogo />
