...
// import { getComments, RelatedCase } from "../../Api/post";
...
export default function SurgeryDetails({ navigation }) {
  ...
  const [proceduralSteps, setSteps] = useState(true);
  ...
  return (
    ...
    <NetworkStatusBanner/>
        ...
        {/* <View style={styles.imgContainer}>
          <Image source={{ uri: route.params.img[1].url }} style={styles.img} />
        </View> */}
        ...
        >
          ...
          {proceduralSteps ? (
            <TouchableOpacity
              ...
              style={[
                styles.tabBar,
                { backgroundColor: proceduralSteps ? "#028704" : "#1989b9" },
              ]}
            >
              <MaterialCommunityIcons
                ...
                color={"#fff"}
              />
              <Text style={styles.tabText}>Procedural steps</Text>
              {proceduralSteps ? (
                <Ionicons
                  name="chevron-down-circle-outline"
                  size={26}
            ...
            <View>
              ...
              <View style={{ marginTop: 8, width: 322 }}>
                ...
                >
                  {FormatText(route.params.procedure)}
                </Text>
              </View>
            </View>
          )}
          ...
          {poc ? (
            <TouchableOpacity
              activeOpacity={0.8}
              onPress={PostOperativeCare}
              style={[
                styles.tabBar,
                { backgroundColor: poc ? "#028704" : "#1989b9" },
              ]}
            >
              <AntDesign name="medicinebox" size={22} color={"#fff"} />
              <Text style={styles.tabText}>Post operative Care(P.o.C)</Text>
              {poc ? (
                <Ionicons
                  name="chevron-down-circle-outline"
                  size={26}
