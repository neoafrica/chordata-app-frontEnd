...
// export default function ClinicalPost({ navigation }) {
...
//       const dimensionCheckedAssets = await Promise.all(dimensionCheckPromises);
...
//             // onSubmit={(values) => onSubmitMethod(values)} //values is an object with age, sex, Type of animal, caseHistory
...
//                   minHeight={100}
//                   value={values.clinicalManagement}
//                   onChangeText={handleChange("clinicalManagement")}
//                 />

//                 <TextInput
//                   Name={"Drugs used"}
//                   minHeight={100}
//                   value={values.drugsUsed}
//                   onChangeText={handleChange("drugsUsed")}
//                 />
...
const FORM_KEY = "clinical_form_data";
            ...
            {({ handleChange, handleSubmit, values, setFieldValue }) => (
              <View style={{ flex: 1, alignItems: "center" }}>
                ...
                <TextInput
                  ...
                  // onChangeText={handleChange("clinicalManagement")}
                  onChangeText={(text) => {
                    handleChange("clinicalManagement")(text);
                    saveFormData({ ...values, clinicalManagement: text });
                  }}
                />
                ...
                <TextInput
                  ...
                  // onChangeText={handleChange("drugsUsed")}
                  onChangeText={(text) => {
                    handleChange("drugsUsed")(text);
                    saveFormData({ ...values, drugsUsed: text });
                  }}
                />
