...
const FORM_KEY = "surgical_form_data";
...
export default function SurgicalPost({ navigation }) {
          ...
          >
            {({ handleChange, handleSubmit, values, setFieldValue }) => (
              <View style={{ flex: 1, alignItems: "center" }}>
                ...
                <TextInput
                  Name={"Reason for Conducting a procedure"}
                  minHeight={120}
                ...
                <TextInput
                  ...
                  minHeight={100}
                  value={values.ProceduralSteps}
                  // onChangeText={handleChange("ProceduralSteps")}

                  onChangeText={(text) => {
                    handleChange("ProceduralSteps")(text);
                    saveFormData({ ...values, ProceduralSteps: text });
                  }}
                />
                <TextInput
                  Name={"Post operative Care (P.o.C)"}
                  minHeight={100}
                  value={values.Poc}
                  // onChangeText={handleChange("Poc")}

                  onChangeText={(text) => {
                    handleChange("Poc")(text);
                    saveFormData({ ...values, Poc: text });
                  }}
                />
